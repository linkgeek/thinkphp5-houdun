<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\AppServ\www\thinkphp5\public/../application/admin/view/article/edit.html";i:1515762130;s:67:"D:\AppServ\www\thinkphp5\public/../application/admin/view/base.html";i:1515681763;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-9">
                        <select class="js-example-basic-single form-control" name="cate_id">
                            ...
                            <?php if(is_array($cateData) || $cateData instanceof \think\Collection || $cateData instanceof \think\Paginator): if( count($cateData)==0 ) : echo "" ;else: foreach($cateData as $key=>$vo): ?>
                                <option <?php if($vo['cate_id']==$oldData['cate_id']): ?>selected<?php endif; ?> value="<?php echo $vo['cate_id']; ?>"><?php echo $vo['_cate_name']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input class="form-control" name="arc_thumb" readonly="" value="<?php echo $oldData['arc_thumb']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="arc_digest"  class="form-control" placeholder=""><?php echo $oldData['arc_digest']; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
