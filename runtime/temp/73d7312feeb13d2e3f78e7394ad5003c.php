<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\AppServ\www\thinkphp5\public/../application/index/view/index/index.html";i:1516022414;s:67:"D:\AppServ\www\thinkphp5\public/../application/index/view/base.html";i:1516023370;}*/ ?>
...
<?php if(is_array($arcticleData) || $arcticleData instanceof \think\Collection || $arcticleData instanceof \think\Paginator): if( count($arcticleData)==0 ) : echo "" ;else: foreach($arcticleData as $key=>$vo): ?>
<article>
	<div class="_head">
				...
				<div class="row">
					<div class="col-sm-4">
						...
						<div id="" class="_single">
							...
							<time><?php echo date('Y-m-d',$vo['sendtime']); ?></time>
						</div>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
