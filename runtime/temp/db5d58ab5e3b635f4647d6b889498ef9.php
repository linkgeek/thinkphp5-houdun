<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\AppServ\www\thinkphp5\public/../application/admin/view/webset/index.html";i:1515851010;s:67:"D:\AppServ\www\thinkphp5\public/../application/admin/view/base.html";i:1515681764;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<script type="text/javascript">
	function change(obj,webset_id){
		...
		$.post("<?php echo url('edit'); ?>",{webset_value:webset_value,webset_id:webset_id},function(res){
				if(res.code){
					alert(res.msg);
