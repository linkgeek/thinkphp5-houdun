<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\AppServ\www\thinkphp5\public/../application/admin/view/link/index.html";i:1515827478;s:67:"D:\AppServ\www\thinkphp5\public/../application/admin/view/base.html";i:1515681763;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="<?php echo url('del',['link_id'=>$vo['link_id']]); ?>" onclick="return confirm('确认删除？')">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
