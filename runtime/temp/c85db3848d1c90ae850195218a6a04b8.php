<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\AppServ\www\thinkphp5\public/../application/admin/view/link/store.html";i:1515828172;s:67:"D:\AppServ\www\thinkphp5\public/../application/admin/view/base.html";i:1515681763;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="index.html" style="color: white;margin-left: -14px">Giant博客网</a>
                </h4>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="link_name" value="<?php echo $oldData['link_name']; ?>"  class="form-control" placeholder="请填写友链名称">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="url" name="link_url" value="<?php echo $oldData['link_url']; ?>"  class="form-control" placeholder="">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">排序</label>
                <div class="col-sm-9">
                    <input type="number" name="link_sort" value="<?php echo $oldData['link_sort']; ?>" class="form-control" placeholder="">
                </div>
            </div>
        </div>
    </div>
    <input type="hidden" name="link_id" value="<?php echo input('param.link_id'); ?>"></input>
