<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\AppServ\www\thinkphp5\public/../application/admin/view/tag/index.html";i:1514794690;s:67:"D:\AppServ\www\thinkphp5\public/../application/admin/view/base.html";i:1515681764;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="<?php echo url('admin/tag/del',['tag_id'=>$vo['tag_id']]); ?>" onclick="return confirm('确定要删除吗！')">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
