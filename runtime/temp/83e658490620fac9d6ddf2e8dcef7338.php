<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\AppServ\www\thinkphp5\public/../application/admin/view/tag/store.html";i:1515037458;s:67:"D:\AppServ\www\thinkphp5\public/../application/admin/view/base.html";i:1515681764;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="container-fluid admin_menu">
    ...
    <form class="form-horizontal" id="form"  action="" method="post">
        ...
        <!-- <input type="hidden" name="tag_id" value="<?php echo input('param.tag_id'); ?>"></input> -->
