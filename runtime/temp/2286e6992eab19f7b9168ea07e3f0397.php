<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\AppServ\www\thinkphp5\public/../application/admin/view/article/recycle.html";i:1515822552;s:67:"D:\AppServ\www\thinkphp5\public/../application/admin/view/base.html";i:1515681764;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="<?php echo url('outRecycle',['arc_id'=>$vo['arc_id']]); ?>">还原</a></li>
                                        <li class="divider"></li>
                                        <li><a href="<?php echo url('del',['arc_id'=>$vo['arc_id']]); ?>" onclick="return confirm('确认删除？')">彻底删除</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
